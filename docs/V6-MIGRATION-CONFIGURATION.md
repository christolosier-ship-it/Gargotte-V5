...
Les deux migrations dans `migrations/` sont appliquées uniquement à la branche de travail `br-wandering-bread-b48avojm`.
...
- Même nom de base IndexedDB V5, version portée de 2 à 3 ; aucun store métier effacé pendant l’upgrade.
